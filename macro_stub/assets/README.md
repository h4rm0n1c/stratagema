...
The CI packaging step will copy this file when present, or fall back to the generated `blank.ico` emitted under `target/**/out/` if the build script creates one.
