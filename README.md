...
The active Cargo workspace only includes `macro_stub`; the archived projects are excluded so their historical lockfiles do not
interfere with current builds.
